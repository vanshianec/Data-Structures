...
public class CTest21 {
    ...
    @Test
    public void getAllInvoiceInPeriod_return_invoices_correctly_for_bigger_range() {
        ...
        List<Invoice> allInvoiceInPeriod = StreamSupport.stream(this.agency.getAllInvoiceInPeriod(LocalDate.of(2017, 1, 12), LocalDate.of(2017, 3, 12)).spliterator(), false)
