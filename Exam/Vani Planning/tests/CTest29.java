...
public class CTest29 {
    ...
    public void getAllFromDepartment_should_return_correct_count() {
        ...
        int actualCount = (int) StreamSupport.stream(this.agency.getAllFromDepartment(Department.INCOMES).spliterator(), false).count();
        final int expectedResult = 2;
        Assert.assertEquals("Incorrect count", expectedResult, actualCount);
    }
}