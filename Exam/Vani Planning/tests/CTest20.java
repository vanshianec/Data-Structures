...
public class CTest20 {
    ...
    @Test
    public void getAllInvoiceInPeriod_return_invoices_correctly_for_single_date() {
        ...
        List<Invoice> allInvoiceInPeriod = StreamSupport.stream(this.agency.getAllInvoiceInPeriod(LocalDate.of(2017, 2, 12), LocalDate.of(2017, 2, 12)).spliterator(), false)
