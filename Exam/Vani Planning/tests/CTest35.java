...
public class CTest35 {
    ...
    @Test
    public void extendDeadline_should_throw_exception() {
        ...
        LocalDate expectedDate = LocalDate.of(2018,3,23);
        this.agency.extendDeadline(LocalDate.of(2018, 3, 13), 10);

        Assert.assertEquals("Incorrect date", expectedDate,inv1.getDueDate());
        Assert.assertEquals("Incorrect date", expectedDate,inv3.getDueDate());
