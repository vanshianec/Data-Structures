...
public class PTest17 {
    ...
    @Test
    public void getAllWithScrenSize_with_100000_entries() {
        ...
        double screenSize = this.generator.getMostOccurrences(computers,Computer::getScreenSize).get().getKey();
        long start = System.currentTimeMillis();
        this.microsystem.getAllWithScreenSize(screenSize);
        long stop = System.currentTimeMillis();

        long elapsedTime = stop - start;

//        throw new IllegalArgumentException("time: " + elapsedTime);
        Assert.assertTrue(elapsedTime <= 45);
    }
