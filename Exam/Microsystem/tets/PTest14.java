...
public class PTest14 {
    ...
    @Test
    public void getAllFromBrand_with_100000_entries() {
        ...
        Brand brand = this.generator.getMostOccurrences(computers,Computer::getBrand).get().getKey();
        long start = System.currentTimeMillis();
        this.microsystem.getAllFromBrand(brand);
        long stop = System.currentTimeMillis();

        long elapsedTime = stop - start;

//        throw new IllegalArgumentException("time: " + elapsedTime);
        Assert.assertTrue(elapsedTime <= 55);
    }
