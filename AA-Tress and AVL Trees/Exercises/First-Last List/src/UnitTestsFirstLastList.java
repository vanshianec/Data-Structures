...
public class UnitTestsFirstLastList {
    ...
    public void add2Items_GetCount_ShouldReturn2() {
        // Arrange
        IFirstLastList<Integer> items = new FirstLastList<>();
    ...
    public void complexTest_AllOperationsStrings() {
        ...
        assertEquals(1, items.removeAll("first"));
        assertEquals(1, items.removeAll("fourth"));
        assertEquals(0, items.removeAll("first"));
